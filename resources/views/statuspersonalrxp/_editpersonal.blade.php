...
<div class="modal fade" id="editPersonal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <form action="{{route('modify.personal.rxp.update', $office->id)}}" method="post">
          <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select" name="rol_id" id="rol">
                            @foreach ($office->oficinaTipo->rols as $rol)
              ...
              <span class="font-italic mb-4 text-primary">Por defecto esta acualización afectará la información del personal seleccionado en su data actual y Mes RxP {{ $month->month }}.</span>
          </div>
